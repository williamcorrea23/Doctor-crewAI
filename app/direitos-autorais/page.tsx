        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="mb-2 font-semibold">Propriedade Intelectual</h3>
                <p className="leading-relaxed text-gray-700">
                  Todo o conteúdo presente neste aplicativo, incluindo textos, imagens, logos,
                  ícones, gráficos, vídeos, áudios e software, é protegido por direitos autorais e
                  outras leis de propriedade intelectual. O conteúdo é de propriedade exclusiva do
                  desenvolvedor ou de seus licenciadores.
                </p>
              </div>

              <div>
                <h3 className="mb-2 font-semibold">Uso Autorizado</h3>
                <p className="leading-relaxed text-gray-700">
                  O uso deste aplicativo é concedido apenas para fins educacionais e pessoais. É
                  proibida a reprodução, distribuição, modificação ou criação de obras derivadas sem
                  autorização expressa por escrito.
                </p>
              </div>

              <div>
                <h3 className="mb-2 font-semibold">Conteúdo de Terceiros</h3>
                <p className="leading-relaxed text-gray-700">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="mb-2 font-semibold">Uso Aceitável</h3>
              ...
              <div>
                <h3 className="mb-2 font-semibold">Uso Proibido</h3>
                <ul className="list-inside list-disc space-y-1 text-gray-700">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="mb-2 font-semibold">Políticas do Google Play</h3>
                <p className="leading-relaxed text-gray-700">
              ...
              <div>
                <h3 className="mb-2 font-semibold">Conteúdo Educacional</h3>
                <p className="leading-relaxed text-gray-700">
              ...
              <div>
                <h3 className="mb-2 font-semibold">Dados do Usuário</h3>
                <p className="leading-relaxed text-gray-700">
                  Coletamos apenas dados necessários para o funcionamento do aplicativo. Todos os
                  dados são tratados de acordo com nossa Política de Privacidade e as
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="mb-2 font-semibold">Bibliotecas Open Source</h3>
                <p className="mb-3 leading-relaxed text-gray-700">
                  Este aplicativo utiliza várias bibliotecas de código aberto. Agradecemos aos
                  desenvolvedores dessas ferramentas:
                </p>
              ...
              <div>
                <h3 className="mb-2 font-semibold">Fontes de Conteúdo</h3>
                <p className="leading-relaxed text-gray-700">
                  O conteúdo educacional é baseado no currículo oficial do ENEM e em materiais
                  educacionais de domínio público, sempre respeitando os direitos autorais e as
                  licenças aplicáveis.
                </p>
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <p className="leading-relaxed text-gray-700">
                Para questões sobre direitos autorais, uso do aplicativo ou relatórios de violação,
              ...
              <div className="mt-4 rounded-lg bg-gray-50 p-4">
                ...
                <p className="mt-1 text-sm text-gray-600">
                  Reservamo-nos o direito de atualizar estas políticas a qualquer momento. As
